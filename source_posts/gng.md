# GNG
I just made a subprocess to send a message to my group-chat full of friends. Every night at 8:31pm my computer will send the message `gng`. This stands for good night gang, and I am interested to see how quickly they will notice the message. I set it for this time because one of my friends has an alarm on his Iphone that he refuses to turn off for the time 8:31pm. I used this python code to do it.
